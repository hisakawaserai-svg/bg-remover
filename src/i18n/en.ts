...
const en: typeof ja = {
  ...
  setup: {
    ...
    manualDesc: 'Enclose each character you want to save. Only enclosed areas are saved. Anything not enclosed is not saved.',
  ...
  howto: {
    ...
    editorPremise:
      'Only areas inside the rectangles (blocks) are saved. Anything not enclosed will not appear on the confirm screen or in the saved files.',
    ...
    editorAddWhere: 'Choose Add rectangle in the tool on the right, then enclose the characters you want to save. Only enclosed areas are saved.',
