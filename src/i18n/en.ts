...
const en: typeof ja = {
  ...
  editor: {
    ...
    modeRestoreHint: 'Paint over parts that were erased too much to bring them back. Switch to "Erase" to make traced areas transparent regardless of color (for isolated spots the eyedropper can\'t reach)',
  ...
  settings: {
    ...
    bgEngineHint: 'Color-based judges by background color. Subject detection (Vision) works better for complex backgrounds and cutting out people.\nNote: Vision may also remove text or logos it judges to be "not the subject."',
    bgEngineHintUnavailable: 'Subject detection (Vision) requires iOS 17 or later on a real device.',
  ...
  errors: {
    ...
    visionUnsupported: 'This background removal method requires iOS 17 or later on a real device.',
