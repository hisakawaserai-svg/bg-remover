...
const en: typeof ja = {
  ...
  bgEngineChoice: {
    ...
    subtitle: 'If you are unsure, use color-based. Which one should this image use?',
    floodDesc: 'Removes areas that match the background color. Best for solid or fairly uniform backgrounds. Start here.',
  ...
  settings: {
    ...
    bgEngineHint: 'Color-based (recommended) judges by background color. Subject detection works better for complex backgrounds and cutting out people.\nNote: text or logos judged to be "not the subject" may also be removed.',
    bgEngineHintUnavailable: 'Subject detection is not available on this OS version.',
    bgEngineFlood: 'Color-based (recommended)',
  ...
  howto: {
    ...
    resultNumbers: 'The “1” at the right of the heading. Hide the numbers and warning marks if they get in the way while checking transparency.',
