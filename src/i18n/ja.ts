...
const ja = {
  ...
  howto: {
    ...
    tabResult: '分割結果',
    tabTrouble: '困ったとき',
    flowLead: '画像を選ぶ → ここで割る → 結果を見て保存。うまく割れなければ「範囲を調整」へ。',
    sectionBasics: '基本',
    sectionWhere: 'どこにあるか',
    sectionTools: '囲み方',
    sectionFix: '直す道具',
    ...
    autoToManual: 'バラバラな並びや、自動で割れないときは上の「範囲を調整」タブへ。',
    editorPremise:
      '四角（ブロック）で囲んだ部分だけが保存されます。囲んでいない絵は、プレビューにも保存にも出ません。',
    editorPinchTitle: '二本指',
    editorPinch: '二本指で画面を動かせます。二本指を広げたり縮めたりすると、拡大・縮小できます。上のズームバーでも変えられます。',
    editorAddWhere: '右の道具から「四角を追加」を選ぶと、下のカードで囲み方を選べます。',
    editorPick: '黄色い枠をタップして選び、「囲む」で四角を置きます。触れている絵は1つの枠になります。',
    editorEraseWhere: '右の道具で復元ブラシを選ぶと、下のカードで消しゴムに切り替えられます。',
    ...
    editorPreview: '下のバーの「プレビュー」。囲んだ分だけ切り出して確認し、保存へ進みます。',
