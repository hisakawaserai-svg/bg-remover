...
const ja = {
  ...
  setup: {
    ...
    manualDesc: '保存したいキャラを四角で囲みます。囲んだ分だけ保存されます。囲んでいない絵は保存されません。',
  ...
  howto: {
    ...
    editorPremise:
      '四角（ブロック）で囲んだ部分だけが保存されます。囲んでいない絵は、確認画面にも保存にも出ません。',
    editorPinchTitle: '二本指',
    editorPinch: '二本指で画面を動かせます。二本指を広げたり縮めたりすると、拡大・縮小できます。上のズームバーでも変えられます。',
    editorAddWhere: '右の道具から「四角を追加」を選び、保存したいキャラを囲みます。囲んだ分だけ保存されます。',
